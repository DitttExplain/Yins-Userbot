...
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════╗\n"
    " “𖣘 𝚂𝙴𝙻𝙰𝙼𝙰𝚃 𝙳𝙰𝚃𝙰𝙽𝙶 𝚃𝙾𝙳 𖣘”    ”\n"
    "╚═════════════════════╝\n"
    "**𝙹𝙰𝙽𝙶𝙰𝙽 𝚂𝙿𝙰𝙼 𝙲𝙷𝙰𝚃 𝙼𝙰𝙹𝙸𝙺𝙰𝙽 𝙶𝚄𝙰 𝙺𝙴𝙽𝚃𝙾𝙳** \n"
    f"**𝙶𝚄𝙰 𝙰𝙺𝙰𝙽 𝙾𝚃𝙾𝙼𝙰𝚃𝙸𝚂 𝙱𝙻𝙾𝙺𝙸𝚁 𝙻𝚄, 𝚃𝚄𝙽𝙶𝙶𝚄 𝚂𝙰𝙼𝙿𝙰𝙾 {DEFAULTUSER} 𝙽𝙴𝚁𝙸𝙼𝙰 𝙿𝙴𝚂𝙰𝙽 𝙻𝚄 [⚠️]({ALIVE_LOGO})** \n"
    "╔═════════════════════╗\n"
    "│𖣘 Pᴇsᴀɴ Oᴛᴏᴍᴀᴛɪs           \n"
    f"│𖣘 𝚈𝙸𝙽𝚂-𝚄𝚂𝙴𝚁𝙱𝙾𝚃           \n"
    "╚═════════════════════╝")
    ...
    if (
        ...
        if not apprv and event.text != UNAPPROVED_MSG:
            ...
            if COUNT_PM[event.chat_id] > 5:
                await event.respond(
                    "`𝙼𝙰𝙼𝙿𝚄𝚂 𝙶𝚄𝙰 𝙱𝙻𝙾𝙺𝙸𝚁, 𝙼𝙰𝙽𝙶𝙺𝙰𝙽𝚈𝙰 𝙹𝙰𝙽𝙶𝙰𝙽 𝚂𝙿𝙰𝙼`\n"
                    f"`𝙺𝙴 𝚁𝙾𝙾𝙼 𝙲𝙷𝙰𝚃 𝙸𝙽𝙸 𝚃𝙾𝙳`"
                )
                ...
                if BOTLOG:
                    ...
                    await event.client.send_message(
                        ...
                        + str(event.chat_id)
                        + ")"
                        + " 𝚄𝙳𝙰𝙷 𝙶𝚄𝙰 𝙱𝙻𝙾𝙺𝙸𝚁 𝙺𝙰𝚁𝙽𝙰 𝙼𝙴𝙻𝙰𝙺𝚄𝙺𝙰𝙽 𝚂𝙿𝙰𝙼 𝙺𝙴 𝚁𝙾𝙾𝙼 𝙲𝙷𝙰𝚃",
                    )
...
async def approvepm(apprvpm):
    ...
    try:
        ...
        return await apprvpm.edit("`𝙾𝙺𝙴 𝙲𝙷𝙰𝚃 𝙻𝚄 𝚄𝙳𝙰𝙷 𝙳𝙸𝚃𝙴𝚁𝙸𝙼𝙰 𝚃𝙾𝙳 ツ`")

    await apprvpm.edit(f"`Hai` [{name0}](tg://user?id={uid}) `𝙲𝙷𝙰𝚃 𝙻𝚄 𝚄𝙳𝙰𝙷 𝙳𝙸𝚃𝙴𝚁𝙸𝙼𝙰 𝚃𝙾𝙳 😎`")
